...
description: "Draft a recurring client progress report from primary evidence, review it for the sponsor, and prepare the authorized delivery format. Use for biweekly or monthly engagement reports; use consulting-stakeholder-update for a short session recap."
---
...
Read the installed `consulting-copy-writer` skill and its relevant references, including the full
...
4. Review through the actual sponsor's needs using `consulting-copy-reviewer`. Any simulated reader

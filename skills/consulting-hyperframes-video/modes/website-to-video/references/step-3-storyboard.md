...
When planning beats, decide which ones deserve an HTML-in-Canvas treatment vs. a standard GSAP animation. If you want it, name it in the storyboard — Step 5 will read [`../../../engine/hyperframes-animation/adapters/html-in-canvas-patterns.md`](../../../engine/hyperframes-animation/adapters/html-in-canvas-patterns.md) for implementation. You don't need to specify the API details here.
